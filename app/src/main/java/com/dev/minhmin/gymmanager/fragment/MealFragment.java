...
//        ref.child(ConstantUtils.Breakfast).addListenerForSingleValueEvent(new ValueEventListener() {
//                @Override
//                public void onDataChange(DataSnapshot dataSnapshot) {
//                    for (DataSnapshot i : dataSnapshot.getChildren()) {
//                        if(i.getKey().equals(date)){
//                            mealBreakfast[0] =i.getValue(Meal.class);
//                        }
//
//                    }
...
//                for (DataSnapshot i : dataSnapshot.getChildren()) {
//                    if(i.getKey().equals(date)){
//                        mealLunch[0] =i.getValue(Meal.class);
//                    }
//
//                }
//            }
...
//                for (DataSnapshot i : dataSnapshot.getChildren()) {
//                    if(i.getKey().equals(date)){
//                        mealDin[0] =i.getValue(Meal.class);
//                    }
//
//                }
//            }
...
//                for (DataSnapshot i : dataSnapshot.getChildren()) {
//                    if(i.getKey().equals(date)){
//                        mealSnack[0] =i.getValue(Meal.class);
//                    }
//
//                }
//            }
...
//        });
        ...
        Meal mealDin = new Meal();
        Meal mealSnack = new Meal();
        ...
        iv_back_left.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                updateUI(mealBreak, mealLunch, mealDin, mealSnack);
